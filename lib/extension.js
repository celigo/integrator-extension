...
const logFunctionMetadata = function (functionOptions, extensionOptions) {
  var logMap = {}
  ...
  for (let [key, value] of Object.entries(logMap)) {
    if (value !== undefined) logInfo = logInfo + `${key}=${value}, `
  }
